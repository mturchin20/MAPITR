...
assign("MAPITR_Output1_pValue1", 0.511314, envir = .GlobalEnv)
assign("MAPITR_Output1_Est1", 1.09663702, envir = .GlobalEnv)
assign("MAPITR_Output1_PVE1", 1.32243728, envir = .GlobalEnv)
assign("MAPITR_Output1_Eigen1", -0.02855374, envir = .GlobalEnv)
assign("MAPITR_Output1_Eigen2", -0.03918452, envir = .GlobalEnv)
...
assign("MAPITR_Output2_pValue1", 0.2208826, envir = .GlobalEnv)
assign("MAPITR_Output2_Est1", 1.2121906, envir = .GlobalEnv)
assign("MAPITR_Output2_PVE1", 1.47945478, envir = .GlobalEnv)
assign("MAPITR_Output2_Eigen1", -0.02899182, envir = .GlobalEnv)
assign("MAPITR_Output2_Eigen2", -0.03836659, envir = .GlobalEnv)
