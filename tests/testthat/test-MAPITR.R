...
assign("MAPITR_Output1_pValue1", 0.019334, envir = .GlobalEnv)
assign("MAPITR_Output1_Est1", 1.07617, envir = .GlobalEnv)
assign("MAPITR_Output1_PVE1", 1.2418, envir = .GlobalEnv)
assign("MAPITR_Output1_Eigen1", -0.01903, envir = .GlobalEnv)
assign("MAPITR_Output1_Eigen2", -0.01732, envir = .GlobalEnv)
...
assign("MAPITR_Output2_pValue1", 0.019334, envir = .GlobalEnv)
assign("MAPITR_Output2_Est1", 1.07617, envir = .GlobalEnv)
assign("MAPITR_Output2_PVE1", 1.2418, envir = .GlobalEnv)
assign("MAPITR_Output2_Eigen1", -0.01903, envir = .GlobalEnv)
assign("MAPITR_Output2_Eigen2", -0.01732, envir = .GlobalEnv)
