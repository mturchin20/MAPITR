...
assign("OrigPhenos", c(0.2999148,-2.1918209,-1.3970979,-0.4458862,0.8048022,-1.4659387,1.6504161,-0.9612443,-0.7646495,-0.6219103), envir = .GlobalEnv)
assign("OrigGenos", c(2,2,0,1,2,1,0,2,1,2), envir = .GlobalEnv)
assign("AdjPhenos", c(5.8193989,5.2890087,-1.3970979,2.4034901,7.8825863,-1.0977948,1.6504161,2.0164610,0.8981305,4.8637056), envir = .GlobalEnv)
assign("Residuals", c(1.02205278,0.49166253,-0.58154207,0.41259495,3.08524020,-3.08868997,2.46597191,-2.78088513,-1.09276466,0.06635945), envir = .GlobalEnv)
...
test_that("Checking behavior of linear regression residuals extraction", {
	expect_equal(residuals(lm(AdjPhenos ~ OrigGenos)), tolerance=1e-6)
}
